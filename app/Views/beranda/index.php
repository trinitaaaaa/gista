	...
	<section class="section bg-light" id="sec-gunung">
		<div class="container">
			...
			<ul class="row mb-4 portfolio-filters isotope-filters aos-init aos-animate" style="justify-content: center;">
				<li class="filter-active col-2 btn btn-sm btn-outline-primary rounded" style="margin-right: 10px; width: 150px; border-color: #FFFFFF;">Sumatra</li>
				<li class=" col-2 btn btn-sm btn-outline-primary rounded" style="margin-right: 10px; width: 150px;border-color: #FFFFFF; ">Sulawesi</li>
				<li class=" col-2 btn btn-sm btn-outline-primary rounded" style="margin-right: 10px; width: 150px; border-color: #FFFFFF; ">Papua</li>
				<li class=" col-2 btn btn-sm btn-outline-primary rounded" style="margin-right: 10px; width: 150px; border-color: #FFFFFF; ">Kalimantan</li>
				<li class=" col-2 btn btn-sm btn-outline-primary rounded" style="margin-right: 10px; width: 150px; border-color: #FFFFFF; ">Bali</li>
				<li class=" col-2 btn btn-sm btn-outline-primary rounded" style="margin-right: 10px; width: 150px; border-color: #FFFFFF; ">Jawa</li>
			</ul>
